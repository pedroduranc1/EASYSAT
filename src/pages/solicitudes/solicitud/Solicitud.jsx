      ...
      <div className={` h-full md:h-[82vh] mb-5 px-[3%] md:px-0 md:mt-5`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:space-x-3">
          ...
          <div className="mt-3 md:mt-0">
            <h2 className="text-2xl font-bold mb-4 md:mb-5">Firma Digital</h2>
            <div className="grid w-full grid-flow-col gap-3 md:p-2 overflow-x-auto">
              <a 
              className="bg-white cursor-pointer flex flex-col items-center justify-center shadow-md w-[130px] h-[100px] rounded-md "
              href={solicitud?.FirmaDigitalUrl} download={`Firma`}>
               <Download />
          ...
          className="mt-3 md:mt-0">
            ...
            <select
              ...
              className={` ${EstatusError ? "bg-red-500 text-white font-bold" : "bg-gray-50"} bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5`}
            >
              <option value="">
                Actualmente: {solicitud?.estatus}
              </option>
