  ...
  return (
    <MainLayout>
      <div className="w-full h-[88vh] px-[3%]">
        <h2 className="text-2xl font-bold text-center py-5">Modificar Blog</h2>
        ...
        >
          ...
          {BlogSelected && (
                <UpdateBlogForm  BlogSelected={BlogSelected} setBlogSelected={setBlogSelected}  AutorUsername={AutorUsername}/>
          )}
        </div>
      </div>
    </MainLayout>
